...
export default function ExtraProductsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      <h1 className="text-2xl font-semibold mb-4">منتجات إضافية</h1>
      {loading ? (
        <div className="text-muted-foreground">Loading…</div>
      ) : products.length === 0 ? (
        <div className="text-muted-foreground">لا توجد منتجات إضافية.</div>
      ) : (
